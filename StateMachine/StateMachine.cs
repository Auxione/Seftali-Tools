...
namespace Seftali.StateMachine {
    ...
    public class StateMachine : MonoBehaviour {
        ...
        public void ChangeTo(int index) {
            ...
            this._currentIndex = Mathf.Clamp(index, 0, this.Count - 1);
        ...
        public void Previous() => this.ChangeTo(this._currentIndex - 1);
        ...
        /// </summary>
        [ContextMenu("Next")]
        public void Next() => this.ChangeTo(this._currentIndex + 1);
